...
Aoe4OverlayWinUI3 is a lightweight real-time query tool designed for *Age of Empires IV* players. Built with WinUI 3, it delivers a native Windows experience to help you know yourself and your enemy on the battlefield.
...
Search for "Aoe4Overlay" in the Microsoft Store and click "Get" for automatic installation. This is the safest method with automatic update support.

## 🛠️ Tech Stack

- **UI Framework**: WinUI 3 (Windows App SDK)
- **Runtime**: .NET 10.0
- **Networking**: HttpClient (Async/Await)
