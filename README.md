...
2. 信任证书（首次安装需要，每台机器只需一次）：
   - 双击 `.cer` 文件，点击“安装证书”；
   - 存储位置选择“本地计算机”，点击“下一步”（系统会要求管理员确认）；
   - 选择“将所有证书都放入下列存储”，点击“浏览”，选中“受信任的根证书颁发机构”，点击“确定”；
   - 点击“下一步”→“完成”，在弹出的安全警告中点击“是”；
   - 重复以上步骤，将证书也安装到“受信任的人”存储。
...
> [!WARNING]
> 旁加载方式需要将自签名证书安装到系统信任区，安装证书存在一定的安全风险，请仅在信任该安装包来源的情况下操作。若不确定，**建议优先通过 Microsoft Store 安装**，商店版本经过微软认证，无需手动信任证书。
...
- 想要新功能？欢迎发起 [Pull Request](https://github.com/FramHerel/Aoe4OverlayWinUI3/pulls)。
 ...
 本项目基于 [MIT 许可证](License.md) 发布，你可以自由使用、修改和分发本项目，包括用于商业用途。
